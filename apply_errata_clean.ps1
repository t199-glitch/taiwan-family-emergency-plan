...
$kwErrata = FromB64 "5L2N572u5pyJ6Kmo"
$srcCorrection = FromB64 "5Yud6Kmo5qCh5q2j6bue5L2N"
...
$leyeCap = FromB64 "MSw1MDDkuro="
$leyeSource = FromB64 "6KmA5pa557K-5rqW5bqn5qiZ6amX"
...
while (-not $parser.EndOfData) {
    ...
    if ($null -ne $cols -and $cols.Count -ge 10) {
        ...
        if ($errata.Contains($kwErrata) -or $errata.Contains("位置")) {
            $sid = 0
...
# Reset point 0 (樂業國小)
$shelters[0].county = $leyeCounty
$shelters[0].district = $leyeDistrict
$shelters[0].name = $leyeName
$shelters[0].address = $leyeAddr
$shelters[0].cap = $leyeCap
$shelters[0].lat = 24.138048674795467
$shelters[0].lng = 120.6949602390905
$shelters[0].source = $leyeSource
